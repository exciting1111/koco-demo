...
const i18n = {
  VN: {
    ...
    ac_tab_all: 'Tất cả (0)',
    ac_tab_shipped: 'Đã gửi hàng (0)',
    ac_tab_completed: 'Đã hoàn thành (0)',
    ac_tab_participating: 'Đang tham gia (0)',
    ac_tab_won: 'Đã trúng (0)',
    ac_tab_not_won: 'Không trúng (0)',
  ...
  CN: {
    ...
    ac_completed: '已完成',
    ac_tab_all: '全部 (0)',
    ac_tab_shipped: '已发货 (0)',
    ac_tab_completed: '已完成 (0)',
    ac_tab_participating: '参与中 (0)',
    ac_tab_won: '已中奖 (0)',
    ac_tab_not_won: '未中奖 (0)',
  ...
  ID: {
    ...
    ac_tab_all: 'Semua (0)',
    ac_tab_shipped: 'Sudah dikirim (0)',
    ac_tab_completed: 'Selesai (0)',
    ac_tab_participating: 'Sedang ikut (0)',
    ac_tab_won: 'Menang (0)',
    ac_tab_not_won: 'Tidak menang (0)',
