...
const i18n = {
  VN: {
    ...
    hero_trust3: 'Bảo đảm hoàn tiền',
    hero_tag_price: 'Giá gốc',
    hero_tag_price_val: '37.990.000₫',
    hero_tag_star: 'KOCO chỉ từ',
  ...
  CN: {
    ...
    hero_trust3: '退款保障',
    hero_tag_price: '原价',
    hero_tag_price_val: '¥9,999',
    hero_tag_star: 'KOCO只要',
    hero_cta: '参与 Wish Purchase →',
    // ---- Slide 2 ----
  ...
  ID: {
    ...
    hero_trust3: 'Jaminan uang kembali',
    hero_tag_price: 'Harga asli',
    hero_tag_price_val: 'Rp25.749.000',
    hero_tag_star: 'KOCO mulai dari',
    hero_cta: 'Ikut Wish Purchase →',
    // ---- Slide 2 ----
